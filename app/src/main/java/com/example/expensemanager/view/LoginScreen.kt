...
@Composable
fun LoginScreen(navigationViewModel: NavigationViewModel, homeViewModel: HomeViewModel) {
        ...
        Button(
            onClick = {
                if (validate(username, password)) {
                    navigationViewModel.setEffect { NavigationContract.Effect.Navigation.ToDashboard }
                } else {
